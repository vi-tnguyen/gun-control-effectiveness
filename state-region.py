...
def gen_data():
    ...
    '''
    state_region = {Northeast: [Connecticut,  Maine, Massachusetts, New Hampshire, Rhode Island, \
    Vermont, New Jersey, New York, Pennsylvania], Midwest: [Iowa (19), Nebraska (31), \
    Kansas (20), North Dakota (38), Minnesota (27), South Dakota (46), Missouri (29),\
    ...
    Arkansas (05), Louisiana (22), Oklahoma (40), Texas (48)], West: [Alaska (02),\
    California (06), Hawaii (15), Oregon (41), Washington (53)]}

    for key in state_region.keys():
        for i in range(len(state_region[key])):
            state_region[key][i] = state_region[key][i][:-3]

    pd_dataframe = pd.DataFrame.from_dict(state_region, orient = 'rows' )
